...
Gem::Specification.new do |s|
  s.name = "billy_the_tool"
  s.version = "0.1.2"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["4pcbr"]
  s.date = "2012-11-29"
  s.description = "Billy is simplified deploy system based on top of capistrano"
  s.email = "me@4pcbr.com"
  s.executables = ["billy"]
  s.extra_rdoc_files = [
    "LICENSE.txt",
    "README.md"
  ...
  s.homepage = "http://github.com/AltSpace/billy"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.24"
  s.summary = "Billy the tool"
